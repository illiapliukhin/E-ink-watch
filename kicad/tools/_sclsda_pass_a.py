#!/usr/bin/env python3
"""Pass A: delete mashed SCL/SDA/FH12 copper. Save. Exit."""
import shutil
...
BACKUP = ROOT / "backups" / f"e-ink-watch.kicad_pcb.pre-sclsda-fh12a-{datetime.now():%H%M%S}"
...
# also real PCB_VIA at wrong U1 pads
