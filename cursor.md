...
- Independent F.Cu-clear 3V3 stitch via `(107.0, 109.59)` `0.25` sits inside In2 r=12 (BTN3 B `+0.225`, `C_BAT` `+0.355`) but will not close west 3V3 vs via `(102.52, 109.40)` without an F.Cu tie or a zone refill. Do not apply expecting an unc drop.
